...
#HACK to add numbers to names so they sort in plots. Could probably use some fancy factor approach
for(i in 1:length(scenNames)) scenNames[i] <- paste0(i,"_", scenNames[i])
...
for (i in 1:4){
 genericRecoverySim(simPar=simPar[i,], cuPar=cuPar,  srDat=srDat,
            ...
            dirName="example", nTrials=25, makeSubDirs=FALSE, random=FALSE)}
